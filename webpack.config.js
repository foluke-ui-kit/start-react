...
var ulgifyPlugin = new UglifyJsPlugin({ minimize: true });
var pluginsArray = [commonsPlugin];
var webpackLoaders = [
...
var entry_file = './public/components.js';
var path = './app';

if(env === 'build'){
  entry_file = './src/index.js';
  path = './dist';
  pluginsArray = [commonsPlugin, ulgifyPlugin];
  // webpackLoaders = [
  //     { test: /(\.jsx|\.js)$/, exclude: [node_modules_dir], loader: "babel"},
  //     { test: /\.less$/, loader: 'style-loader!css-loader!less'},
  //     { test: /\.css$/, loader: 'style-loader!css-loader'},
